...
const translations = {
  ...
  en: {
    ...
    'hero.subtitle': 'MediTrack uses IoT to monitor medical supplies and medications in real-time, ensuring safety and efficiency.',
    ...
    'benefits.realtime.desc': 'IoT sensors monitoring temperature, humidity, and location 24/7',
    'benefits.alerts.title': 'Automatic Alerts',
    'benefits.alerts.desc': 'Immediate notifications for any anomalies or risks',
    'benefits.analytics.title': 'Multiplatform Access',
    'benefits.analytics.desc': 'Check and manage the inventory from the mobile app or web, anytime and anywhere.',
    'benefits.compliance.title': 'Regulatory Compliance',
    'benefits.compliance.desc': 'Ensures compliance with health regulations and standards',
    ...
    'benefits.security.desc': 'Ensures quality of critical medications and supplies',

    // Pricing Section
    'pricing.title': 'Plans & Pricing',
    'pricing.subtitle': 'Choose the plan that best fits your institution',
    ...
    'pricing.pro.desc': 'For medium hospitals',
    'pricing.pro.features': 'Up to 200 sensors,Predictive analytics,Real-time reports,Priority support,Custom API',
    'pricing.enterprise.title': 'Enterprise',
    'pricing.enterprise.price': 'Custom',
    'pricing.enterprise.desc': 'For large institutions',
    'pricing.enterprise.features': 'Unlimited sensors,Advanced AI,Full integration,Dedicated support,Complete customization',
    ...
    'footer.mission.text': 'Optimize medical inventory management through IoT solutions that ensure availability, conservation, and traceability.',
    'footer.links': 'Links',
